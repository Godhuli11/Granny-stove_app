...
import 'package:main_food_ingrdients_app/widgets/app_column.dart';
import 'package:main_food_ingrdients_app/widgets/big_text.dart';
import 'package:main_food_ingrdients_app/widgets/icon_and_text_widget.dart';
...
class FoodPageBody extends StatefulWidget {
  ...
  @override
  State<FoodPageBody> createState() => _FoodState();
}

class _FoodState extends State<FoodPageBody> {
                             ...
                             child: Padding(
                               ...
                               child: Column(
                                 ...
                                 children: [
                                   ...
                                   SmallText(text: "For that post-nighout time"),
                                   SizedBox(height: Dimensions.height10,),
                                   Row(
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: index.isEven?Color(0xffD8F29E):Color(0xff9294cc),
                  image: DecorationImage(
                      fit : BoxFit.cover,
                      image: NetworkImage(

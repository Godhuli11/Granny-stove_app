...
class CustomButton extends StatelessWidget {
  ...
  final IconData? icon;
   ...
   this.marginal,
     this.height,
     this.width ,this.icon,this.fontSize,this.radius=5
   }) : super(key: key);
          ...
          child: Row(
            ...
            children: [
              icon!=null?Padding(
                ...
                child:Icon(icon,color: transparent?Theme.of(context).primaryColor:Theme.of(context).cardColor,) ,):SizedBox(),
               Text(
